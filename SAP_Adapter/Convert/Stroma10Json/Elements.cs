...
namespace BH.Engine.Environment.SAP.Stroma10
{
    public static partial class Convert
    {
        ...
        public static Dictionary<string, object> FromElements(Elements obj)
        {
            ...
            {
                rtn.Add("Fabric", new List<object>());
            }
            ...
            {
                rtn.Add("Heating", new List<object>());
            }
            ...
            {
                rtn.Add("Ventilation", new List<object>());
            }
            ...
            {
                rtn.Add("Renewable", new List<object>());
            }
            ...
            {
                rtn.Add("Overheating", new List<object>());
            }
