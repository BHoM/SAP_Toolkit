...
namespace BH.oM.Environment.SAP
{
    ...
    public enum TypeOfSpaceHeating
    {
        NonePresent = 699,
        BoilerSystem_SolidFuelManualFeed = 151,
        BoilerSystem_SolidFuelAutoFeed = 153,
        BoilerSystem_SolidFuelWoodChip = 155,
        BoilerSystem_SolidFuelOpenFire = 156,
        BoilerSystem_SolidFuelClosedRoom = 158,
        BoilerSystem_SolidFuelStove = 159,
        BoilerSystem_SolidFuelRangeCookerIntegral = 160,
        BoilerSystem_SolidFuelRangeCookerIndependent = 161,
        BoilerSystem_ElectricBoilerDirect = 191,
        ...
        HeatPumpWithRadiator_WithRadiatorElectricPumpGroundSourceLessThan35 = 211,
        HeatPumpWithRadiator_WithRadiatorElectricPumpWaterSourceLessThan35 = 213,
        HeatPumpWithRadiator_WithRadiatorElectricPumpAirSourceLessThan35 = 214,
        HeatPumpWithRadiator_WithRadiatorElectricPumpGroundSourceOther = 221,
        HeatPumpWithRadiator_WithRadiatorElectricPumpWaterSourceOther = 223,
        HeatPumpWithRadiator_WithRadiatorElectricPumpAirSourceOther = 224,
        HeatPumpWithRadiator_WithRadiatorGasPumpGroundSourceLessThan35 = 215,
        HeatPumpWithRadiator_WithRadiatorGasPumpWaterSourceLessThan35 = 216,
        HeatPumpWithRadiator_WithRadiatorGasPumpAirSourceLessThan35 = 217,
        HeatPumpWithRadiator_WithRadiatorGasPumpGroundSourceOther = 225,
        HeatPumpWithRadiator_WithRadiatorGasPumpWaterSourceOther = 226,
        HeatPumpWithRadiator_WithRadiatorGasPumpAirSourceOther = 227,
        HeatPumpWithWarmAir_WarmAirElectricPumpGroundSource = 521,
        HeatPumpWithWarmAir_WarmAirElectricPumpWaterSource = 523,
        HeatPumpWithWarmAir_WarmAirElectricPumpAirSource = 524,
        HeatPumpWithWarmAir_WarmAirGasPumpGroundSource = 525,
        HeatPumpWithWarmAir_WarmAirGasPumpWaterSource = 526,
        HeatPumpWithWarmAir_WarmAirGasPumpAirSource = 527,
        HeatNetwork_BoilersOnlyRdSAP = 301,
        HeatNetwork_CHPAndBoilerRdSAP = 302,
        HeatNetwork_HeatPumpRdSAP = 304,
        ElectricStorage_OldHeater = 401,
        ...
        ElectricUnderfloor_InConcrete = 421,
        ...
        WarmAir_GasBalancedOrOpenFlueDuctedOnOffControlPre1998 = 506,
        ...
        WarmAir_LiquidDuctedOnOffControl = 512,
        WarmAir_LiquidDuctedModulatingControl,
        WarmAir_LiquidStubDuctSystem,
        WarmAir_ElectricaireSystem = 515,
        RoomHeater_GasOpenFluePre1980 = 601,
        ...
        RoomHeater_GasFireOrWallHeaterBalancedFlue = 609,
        RoomHeater_GasFireClosedFrontedFanAssistes = 610,
        RoomHeater_CondensingGasFire = 611,
        RoomHeater_DecorativeFuelGasFire = 612,
        RoomHeater_FluelessGasFire = 614,
        RoomHeater_LiquidFuelPre2000 = 621,
        RoomHeater_LiquidFuelPre200WithBoiler = 622,
        RoomHeater_LiquidFuelPost2000 = 623,
        RoomHeater_LiquidFuelPost2000WithBoiler,
        RoomHeater_LiquidFuelBioethanolHeaterSecondaryOnly = 625,
        RoomHeater_SolidFuelOpenFire = 631,
        RoomHeater_SolidFuelOpenFireWithBackBoiler = 632,
        ...
        RoomHeater_ElectricPanelConvectorOrRadiant = 691,
        RoomHeater_ElectricWaterOrOil = 694,
        RoomHeater_ElectricFanHeater = 692,
        RoomHeater_ElectricPortable = 693,
        Other_ElectricCeilingHeating = 701,
        GasBoiler_Post1998NonCondensingAutomaticIgnition = 101,
        GasBoiler_Post1998CondensingWithAutomaticIgnition = 102,
        ...
        GasBoiler_Post1998BackBoilerToRadiators,
        GasBoiler_Pre1998WithFanAssistedFlueLowThermalCapacity = 110,
        ...
        RangeCookerLiquidFuel_SingleBurner = 139,
