...
namespace BH.oM.Environment.SAP
{
    ...
    public enum HeatingControlCode
    {
        ...
        Boiler_ThermostatAndTRVs = 2113,
        Boiler_ProgrammerThermostatAndTRVs = 2106,
        Boiler_TRVsAndBypass = 2111,
        Boiler_ProgrammerTRVsAndBypass = 2107,
        Boiler_ProgrammerTRVsAndFlowSwitch,
        Boiler_ProgrammerTRVsAndEnergyManager,
        Boiler_TimeAndTempControlByPlumbingAndElectrical,
        Boiler_TimeAndTempControlByPCDB = 2112,
        HeatPump_NoTimeOrThermostaticControl = 2201,
        ...
        HeatPump_ThermostatAndTRVs = 2209,
        HeatPump_ProgrammerThermostatAndTRVs = 2210,
        HeatPump_ProgrammerTRVsAndBypass = 2206,
        HeatPump_TimeAndTempControlByPlumbingAndElectrical,
        HeatPump_TimeAndTempControlByPCDB = 2208,
        HeatNetworks_FlatRateNoThermostaticControl = 2301,
        HeatNetworks_FlatRateProgrammerOnly = 2302,
        HeatNetworks_FlatRateThermostatOnly,
        HeatNetworks_FlatRateProgrammerAndThermostat,
        HeatNetworks_FlatRateThermostatAndTRVs = 2313,
        HeatNetworks_FlatRateTRVs = 2307,
        HeatNetworks_FlatRateProgrammerAndTRVs = 2305,
        HeatNetworks_FlatRateProgrammerAndMoreThanOneThermostat = 2311,
        HeatNetworks_ChargingSystemThermostatOnly = 2308,
        HeatNetworks_ChargingSystemProgrammerAndThermostat,
        HeatNetworks_ChargingSystemThermostatAndTRVs = 2314,
        HeatNetworks_ChargingSystemTRVs = 2310,
        HeatNetworks_ChargingSystemProgrammerAndTRVs = 2306,
        HeatNetworks_ChargingSystemProgrammerAndMoreThanOneThermostat = 2312,
        ElectricStorage_Manual = 2401,
        ElectricStorage_Automatic,
        ElectricStorage_CelectType,
        ElectricStorage_ControlsForHighHeatRetention,
        WarmAir_NoTimeOrThermostaticControl = 2501,
        ...
        RooomHeater_NoThermostaticControl = 2601,
        ...
        Other_NoTimeOrThermostaticControl = 2701,
