...
namespace BH.oM.Environment.SAP
{
    ...
    public class KitchenVentilation : BHoMObject
    {
        ...
        public virtual int RoomFans { get; set; } = 0; //maybe separate kitchen comp
        ...
        public virtual string RoomFansSpecificPower { get; set; } = ""; //maybe separate kitchen comp
        ...
        public virtual int WallFans { get; set; } = 0; //maybe separate kitchen comp
        ...
        public virtual string WallFansSpecificPower { get; set; } = ""; //maybe separate kitchen comp
