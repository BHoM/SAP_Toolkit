...
namespace BH.oM.Environment.SAP.XML
{
    ...
    public class Ventilation : IObject
    {
        ...
        public virtual int FluelessGasFiresCount { get; set; } = 0;
        ...
        public virtual double AirPermeability { get; set; } = 0;
        ...
        public virtual int MechanicalVentSystemIndexNumber { get; set; } = 0;
        ...
        public virtual int WetRoomsCount { get; set; } = 0;
        ...
        public virtual int PSVCount { get; set; } = 0;
        ...
        public virtual int MechanicalVentDuctsIndexNumber { get; set; } = 0;
